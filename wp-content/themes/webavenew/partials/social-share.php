...
<div class="social-media">
	...
	<ul class="social-media-buttons">
		<li><b>Social Share: </b></li>
	    <li>
	        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank"><i class="icon-facebook-with-circle"></i></a>
	    </li>
	    <li>
	        <a href="https://www.instagram.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank"><i class="icon-instagram-with-circle"></i></a>
	    </li>
	    <li>
	        <a href="https://twitter.com/intent/tweet?text=<?php the_permalink(); ?>" target="_blank"><i class="icon-twitter-with-circle"></i></a>
	    </li>
	    <!--<li>
	        <a href="https://www.youtube.com" target="_blank"><i class="icon-youtube-with-circle"></i></a>
	    </li>-->
	</ul>
</div>